...
- `HST` (Home shot on target): Each additional shot on target by the home team reduces the probability of a successful comeback for the away team by 1.17%. A higher number of shots on target indicates that the home team continues to press offensively after taking the lead, which may result in scoring even more goals in the second half.
